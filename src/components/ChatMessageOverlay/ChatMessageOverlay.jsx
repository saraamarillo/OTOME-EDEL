...
function ChatIcon() {
  return (
    <svg viewBox="0 0 959.5 955.7" className={styles.icon} fill="currentColor">
...
export default function ChatMessageOverlay({ node, onAdvance }) {
  ...
  return (
    <div className={styles.wrapper} onClick={(e) => { e.stopPropagation(); onAdvance() }}>
      ...
      <div className={styles.senderCircle} style={{ borderColor: theme }}>
      ...
      {/* Tarjeta de mensaje */}
      <div className={styles.bubble} style={{ borderTopColor: theme }}>
        <div className={styles.cardHead}>
          <span className={styles.iconInline} style={{ color: theme }}><ChatIcon /></span>
          <span className={styles.name} style={{ color: theme }}>{displayName}</span>
